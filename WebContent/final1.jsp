...
String sql ="select DISTINCT(itemid),name from menuitem ";
System.out.println("_____________________________________________");	


PreparedStatement preparedStatement=null;
String sql1 ="select SUM(quantity) from orderline where itemid=?";
...
while(resultSet2.next()){
	System.out.println("_____________________________________________");	
	al.add(resultSet2.getString("name"));
	//al.add(resultSet.getInt("itemid"));
	...
	while(resultSet.next()){
		System.out.println("_____________________________________________");	
		al1.add(resultSet.getInt("SUM(quantity)"));
	}
}
